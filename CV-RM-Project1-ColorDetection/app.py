...
if st.session_state.camera_running:
    ...
    if frame_count >= max_frames:
        st.warning("⚠️ Camera stopped after reaching frame limit. Click 'Start Camera' to restart.")
        st.session_state.camera_running = False

elif st.session_state.stop_requested:
    st.success("✅ Camera stopped successfully. Click 'Start Camera' to begin detection.")
else:
    st.info("👆 Click 'Start Camera' to begin real-time color detection.")